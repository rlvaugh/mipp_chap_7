...
LAT_30_S = LAT_30_N * 2
RECT_START_U_LEFT_X = 0
RECT_START_U_LEFT_Y = LAT_30_N
RECT_START_L_RIGHT_X = RECT_WIDTH
RECT_START_L_RIGHT_Y = LAT_30_N + RECT_HT
...
class Search():
    ...
    def run_rect_stats(self):
        ...
        ul_x, ul_y = RECT_START_U_LEFT_X, RECT_START_U_LEFT_Y
        lr_x, lr_y = RECT_START_L_RIGHT_X, RECT_START_L_RIGHT_Y
        rect_num = 1
    ...
    def draw_qc_rects(self):
        ...
        for k, v in rects_sorted:
            print("rect: {}, coords (ul_x, ul_y, lr_x, lr_y): {}".format(k, v))
    ...
    def make_final_display(self):
        ...
        canvas = tk.Canvas(screen, width=IMG_WIDTH,
                           height=IMG_HT + 130)
